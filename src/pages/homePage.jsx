...
const allProducts = [
  ...
  { id: 2, name: 'Adidas Ultraboost', image: 'https://authenticfeet.vtexassets.com/arquivos/ids/434723-800-800?v=638562278565370000&width=800&height=800&aspect=true', price: 200, category: 'Tênis' },
  { id: 3, name: 'Puma RS-X', image: 'https://a-static.mlcdn.com.br/800x560/tenis-puma-rs-x-3d-masculino/b2online/3943110242/53502c5bb7a4aca0addb96f6ac8635a6.jpeg', price: 99.9, category: 'Tênis' },
  { id: 4, name: 'New Balance 574', image: '/src/assets/new-balance-574.png', price: 150, priceDiscount: 120, category: 'Tênis' },
  { id: 5, name: 'Asics Gel-Kayano', image: '/src/assets/asics-gel-kayano.png', price: 75, category: 'Tênis' },
  ...
  { id: 11, name: 'Calça Puma Training', image: '/src/assets/calcas.png', price: 180, priceDiscount: 149.9, category: 'Calças' },
        ...
        <Section>
          <div className="flex justify-center gap-6 flex-wrap px-4 md:px-0 mt-10">
            {categoryIcons.map((item, index) => (
              <div key={index} onClick={() => handleCategoryClick(item.label)} className="flex flex-col items-center gap-2 cursor-pointer group">
                <div className={`w-24 h-24 rounded-full shadow-md flex items-center justify-center transition-colors ${
                  selectedCategory === item.label
                    ? 'bg-primary text-white border-2 border-primary'
                    : 'bg-white text-gray-700 group-hover:text-pink-600'
                }`}>
                  {item.icon}
                </div>
                <span className={`text-sm font-medium transition-colors ${
                  selectedCategory === item.label ? 'text-primary' : 'text-gray-700 group-hover:text-pink-600'
                }`}>
                  {item.label}
                </span>
              </div>
          ...
          {selectedCategory && (
            <div className="flex justify-center mt-4">
              <button onClick={() => setSelectedCategory(null)} className="text-primary text-sm font-medium hover:underline">
